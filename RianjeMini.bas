Attribute VB_Name = "RisanjeMini"
Option Explicit


Const minifaktor = 335
Global minipolozaji(9, 9) As String * 2
Global minicrnipripravljen As Boolean
Global minipozrtih(2) As Integer
Global ministatusPoteze As String
Global minibelarosadamogocalevo As Boolean
Global minicrnarosadamogocalevo As Boolean
Global minibelarosadamogocadesno As Boolean
Global minicrnarosadamogocadesno As Boolean
...
miniSahovnica.Top = pcy
miniSahovnica.Left = pcx
...
'MsgBox "izvajam minipremik " & poteza
